    ...
    "paths": {
        ...
        "/api/mahasiswa/change-password": {
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Payload untuk ubah password",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "model.Response401": {
            ...
            "properties": {
                "message": {
                    "type": "string",
                    "example": "Unauthorized - Token JWT tidak valid atau tidak ditemukan"
                }
            }
        },
        "model.Response403": {
            ...
            "properties": {
                "message": {
                    "type": "string",
                    "example": "Forbidden - Anda tidak memiliki akses ke resource ini (Role bukan admin)"
                }
            }
        }
    },
